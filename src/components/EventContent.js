// src/components/EventContent.js
...
const EventContent = ({
  ...
  return (
    <ImageBackground
      // Boss-Bild als Hintergrund
      source={currentEvent ? { uri: currentEvent.image } : undefined}
    ...
    >
      <Pressable onPress={onScreenTap} style={styles.overlay}>
        ...
        {/* HP-Progressbar des Bosses */}
        <View style={styles.hpBarContainer}>
          <View style={[styles.hpBar, { width: `${enemyHpPercentage}%` }]} />
